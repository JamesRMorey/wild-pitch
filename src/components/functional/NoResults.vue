...
<template>
    <div class="flex-col inline-flex justify-center items-center text-center p-6">
        <div class="bg-cover aspect-square bg-no-repeat h-96" :style="{ backgroundImage: `url(${image})`}"></div>
