...
<template>
    <div class="w-full flex-col gap-12 inline-flex inline-flex py-60 justify-center items-center bg-center bg-cover" :style="{ backgroundImage: `url(${background})`}">
        <div class="inline-flex flex-col text-center gap-2 p-8 bg-black rounded-2xl bg-opacity-40">
            <slot name="content"></slot>
        </div>
        <div class="bg-white p-8 shadow rounded-3xl inline-flex flex-col gap-3">
