...
<template>
    <div class="w-full flex-col px-10 md:px-0 gap-12 inline-flex inline-flex py-16 lg:py-40 justify-center items-center bg-center bg-cover" :style="{ backgroundImage: `url(${background})`}">
