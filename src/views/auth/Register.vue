            ...
            <form @submit="handleSubmit">
                <div class="inline-flex flex-col h-full justify-center item-center gap-5 px-16">
                    ...
                    <div class="flex-col inline-flex gap-3">
                        ...
                        <input type="text" class="bg-gray-100 rounded-full py-3 px-5" placeholder="name" v-model="formData.name"/>
                    </div>
                    <div class="flex-col inline-flex gap-3">
                    ...
                    <div class="flex-col inline-flex gap-3">
                        <div class="text-lg">Password</div>
                        <input type="password" class="bg-gray-100 rounded-full py-3 px-5" placeholder="password" v-model="formData.confirmPassword"/>
                    </div>
